# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixInfobar.py
...
def main(session, **kwargs):
    session.open(MyMetrixInfobarWindow)
