# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixDesigns.py
...
class MyMetrixDesignsWindow(Screen, ConfigListScreen):
    ...
    def GetPicturePath(self):
        try:
            ...
            path = self.downloadFile(self.screenshotpath + returnValue)
            return path
        except:
            pass
