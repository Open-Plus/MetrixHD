# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrix_GenerateSkin.py
import threading
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-GenerateSkin" position="0,1006" size="1920,64" flags="wfNoBorder" backgroundColor="#40000000">\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1685,14" size="163,33" text="Cancel" transparent="1" />\n \n  <eLabel position="30,7" size="211,50" text="MyMetrix" font="Regular; 40" valign="center" transparent="1" backgroundColor="#40000000" noWrap="1" />\n  <eLabel position="245,7" size="282,50" text="Generating MetrixHD" foregroundColor="#00ffffff" font="Regular; 25" valign="center" backgroundColor="#40000000" transparent="1" halign="left" noWrap="1" />\n  <eLabel position="1673,13" size="5,50" backgroundColor="#00ff0000" />\n   \n<widget name="output" position="539,10" size="1062,43" foregroundColor="#00ffffff" font="Regular; 22" valign="center" backgroundColor="#40000000" transparent="1" halign="center" noWrap="1" /> \n  </screen>\n'
    else:
