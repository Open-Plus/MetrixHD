# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrix_MainMenu.py
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-Menu" position="0,0" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">\n    <eLabel position="478,206" zPosition="-1" size="340,320" backgroundColor="#40000000" transparent="0" />\n    <!-- /*ClockWidget-->\n    <widget source="global.CurrentTime" foregroundColor="unffa500" render="Label" position="664,551" size="169,80" font="SetrixHD; 60" halign="left" backgroundColor="#3c00236b" transparent="1" valign="top">\n      <convert type="ClockToText">Default</convert>\n    </widget>\n    <widget source="global.CurrentTime" render="Label" position="499,595" size="148,29" font="SetrixHD; 20" halign="right" backgroundColor="#3c00236b" foregroundColor="white" transparent="1">\n      <convert type="ClockToText">Format:%e. %B</convert>\n    </widget>\n    <widget source="global.CurrentTime" render="Label" position="522,566" size="125,30" font="SetrixHD; 20" halign="right" backgroundColor="#3c00236b" foregroundColor="white" transparent="1">\n      <convert type="ClockToText">Format:%A</convert>\n    </widget>\n    <eLabel position="478,560" zPosition="-1" size="340,70" backgroundColor="#3c00236b" transparent="0" />\n    <!--ClockWidget */-->\n    \n<widget name="menu" position="918,217" size="530,655" scrollbarMode="showNever" itemHeight="60" enableWrapAround="1" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000">\n    </widget>\n    <eLabel name="" position="927,center" zPosition="-19" size="512,665" backgroundColor="#40000000" foregroundColor="#40000000" />\n    <ePixmap position="502,215" size="300,300" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/mymetrix.png" alphatest="blend" />\n</screen>\n'
    else:
        skin = '\n<screen name="MyMetrix-Menu" position="0,0" size="1200,640" flags="wfNoBorder" backgroundColor="transparent">\n    <eLabel position="264,51" zPosition="-1" size="340,320" backgroundColor="#40000000" transparent="0" />\n    <!-- /*ClockWidget-->\n    <widget source="global.CurrentTime" foregroundColor="#00ffffff" render="Label" position="450,401" size="169,80" font="SetrixHD; 60" halign="left" backgroundColor="#40000000" transparent="1" valign="top">\n      <convert type="ClockToText">Default</convert>\n    </widget>\n    <widget source="global.CurrentTime" render="Label" position="290,444" size="148,29" font="SetrixHD; 20" halign="right" backgroundColor="#40000000" foregroundColor="#00bbbbbb" transparent="1">\n      <convert type="ClockToText">Format:%e. %B</convert>\n    </widget>\n    <widget source="global.CurrentTime" render="Label" position="313,415" size="125,30" font="SetrixHD; 20" halign="right" backgroundColor="#40000000" foregroundColor="#00bbbbbb" transparent="1">\n      <convert type="ClockToText">Format:%A</convert>\n    </widget>\n    <eLabel position="265,410" zPosition="-1" size="340,70" backgroundColor="#40000000" transparent="0" />\n    <!--ClockWidget */-->\n    \n<widget name="menu" position="636,60" size="430,555" scrollbarMode="showNever" itemHeight="60" enableWrapAround="1" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000">\n    </widget>\n    <eLabel name="" position="645,51" zPosition="-19" size="412,565" backgroundColor="#40000000" foregroundColor="#40000000" />\n    <ePixmap position="285,62" size="300,300" pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/mymetrix.png" alphatest="blend" />\n</screen>\n'
