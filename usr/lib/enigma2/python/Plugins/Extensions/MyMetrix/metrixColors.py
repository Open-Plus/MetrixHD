# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixColors.py
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-MetrixColors" position="0,0" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">\n    <eLabel position="315,center" size="620,700" backgroundColor="#40111111" zPosition="-1" />\n  <eLabel position="935,center" size="614,636" backgroundColor="#40222222" zPosition="-1" />\n\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="380,850" size="250,33" text="%s" transparent="1" />\n <widget name="config" itemHeight="30" position="333,303" scrollbarMode="showNever" size="590,506" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000" />\n  <eLabel position="331,205" size="348,50" text="MyMetrix" font="Regular; 40" valign="center" transparent="1" backgroundColor="#40000000" />\n  <eLabel position="572,205" size="349,50" text="MetrixColors" foregroundColor="#00ffffff" font="Regular; 30" valign="center" backgroundColor="#40000000" transparent="1" halign="left" />\n  <eLabel position="367,850" size="5,40" backgroundColor="#00ff0000" />\n    <eLabel position="1251,818" size="5,40" backgroundColor="#000000ff" />\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1264,817" size="270,33" text="%s" transparent="1" />\n\n <eLabel position="649,850" size="5,40" backgroundColor="#0000ff00" />\n  <widget name="buttonGreen" font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="662,850" size="250,33" transparent="1" />\n\n\n <eLabel position="976,818" size="5,40" backgroundColor="#00ffff00" />\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="989,817" size="250,33" text="%s" transparent="1" />\n\n   <ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/images/metrixcolors.png" position="969,274" size="550,500" zPosition="1" />\n  </screen>\n' % (_('Discard'), _('Preview SecondInfoBar'), _('Preview InfoBar'))
    else:
