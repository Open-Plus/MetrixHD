# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrix_Settings_SkinParts.py
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-MySkinParts" position="center,center" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">\n<eLabel position="365,143" size="620,793" backgroundColor="#40111111" zPosition="-1" />\n<eLabel position="985,201" size="575,679" backgroundColor="#40222222" zPosition="-1" />\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1016,840" size="160,33" text="%s" transparent="1" />\n <widget name="mainmenu" position="381,220" scrollbarMode="showNever" size="590,687" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000" />\n  <widget position="381,162" size="589,50" foregroundColor="#00ffffff" name="title" font="SetrixHD; 40" valign="center" transparent="1" backgroundColor="#40000000" />\n  \n  <eLabel position="1004,840" size="5,40" backgroundColor="#00ff0000" />\n<widget position="998,650" size="550,172" name="description" foregroundColor="#00ffffff" font="Regular; 17" valign="center" halign="left" transparent="1" backgroundColor="#40000000" />\n\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1207,840" size="162,33" text="%s" transparent="1" />\n<widget name="helperimage" position="998,327" size="550,310" zPosition="1" alphatest="blend" />\n<widget position="998,213" size="550,50" name="itemname" foregroundColor="#00ffffff" font="SetrixHD; 35" valign="center" transparent="1" backgroundColor="#40000000" noWrap="1" />\n <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1396,840" size="162,33" text="%s" transparent="1" />\n<eLabel position="1195,840" zPosition="1" size="5,40" backgroundColor="#0000ff00" />\n<widget position="998,269" size="341,50" name="author" foregroundColor="#00bbbbbb" font="Regular; 28" valign="center" backgroundColor="#40000000" transparent="1" halign="left" />\n\n<eLabel position="1384,840" zPosition="1" size="5,40" backgroundColor="#000000ff" />\n\n<widget position="1345,273" size="203,40" name="date" foregroundColor="#00999999" font="Regular; 25" valign="center" backgroundColor="#40000000" transparent="1" halign="right" zPosition="1" />\n\n\n </screen>\n' % (_('Disable'), _('Enable'), _('Delete'))
    else:
