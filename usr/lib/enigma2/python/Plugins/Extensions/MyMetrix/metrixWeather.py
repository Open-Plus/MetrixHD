# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixWeather.py
...
def main(session, **kwargs):
    session.open(MyMetrixWeatherWindow)
