# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixPreview.py
...
def main(session, **kwargs):
    session.open(MetrixPreviewWindow)


class MetrixPreviewWindow(ConfigListScreen, Screen):
    ...
    def __init__(self, session):
        ...
        self['TempC'] = Label(_('\xc2\xb0C'))
        self['TempA'] = Label(_('23\xc2\xb0C'))
        self['TempB'] = Label(_('16\xc2\xb0C'))
        self['TempCode'] = Label(_('H'))
        self['TempC2'] = Label(_('18\xc2\xb0C'))
        self['TempD'] = Label(_('12\xc2\xb0C'))
        ...
        self['Crypt'] = Label()
        self['actions'] = ActionMap(['OkCancelActions', 'DirectionActions', 'InputActions'], {'cancel': self.exit}, -1)
