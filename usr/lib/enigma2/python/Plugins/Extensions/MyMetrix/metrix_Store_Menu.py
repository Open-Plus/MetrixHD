# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrix_Store_Menu.py
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-Store" position="0,0" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">\n<eLabel position="center,center" size="1920,1080" backgroundColor="transparent" zPosition="-50" />\n<eLabel position="320,122" size="620,835" backgroundColor="#40111111" zPosition="-1" />\n<eLabel position="940,185" size="575,711" backgroundColor="#40222222" zPosition="-1" />\n<eLabel position="919,123" size="5,60" backgroundColor="#000000ff" />\n<widget position="775,136" size="136,40" name="sort" foregroundColor="#00bbbbbb" font="Regular; 25" valign="center" backgroundColor="#40000000" transparent="1" halign="right" />\n <widget name="menu" position="951,266" selectionDisabled="1" scrollbarMode="showNever" size="549,588" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000" />\n  <widget position="335,130" size="438,50" name="title" foregroundColor="#00ffffff" font="SetrixHD; 40" valign="center" transparent="1" backgroundColor="#40000000" />\n <widget name="mainmenu" position="335,194" scrollbarMode="showNever" size="590,735" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000" />\n  <widget position="951,201" size="558,50" foregroundColor="#00ffffff" name="subtitle" font="SetrixHD; 35" valign="center" transparent="1" backgroundColor="#40000000" />\n </screen>\n'
    else:
