# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/encode.py
...
class MultipartParam(object):
    ...
    def from_file(cls, paramname, filename):
        ...
        """
        return cls(paramname, filename=os.path.basename(filename), filetype=mimetypes.guess_type(filename)[0], filesize=os.path.getsize(filename), fileobj=open(filename, 'r'))
        ...
        for item in params:
            ...
            if hasattr(value, 'read'):
                ...
                if filename is not None:
                    ...
                    filetype = None
                retval.append(cls(name=name, filename=filename, filetype=filetype, fileobj=value))
            else:
