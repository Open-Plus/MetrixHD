# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrixDefaults.py
...
def loadDefaults():
    ...
    config.plugins.MyMetrix.templateFile = ConfigSelection(default='MetrixHD_Openplus_Mod_by_VillaK.xml', choices=getTemplateFiles())
    config.plugins.MyMetrix.showFirstRun = ConfigSelection(default='0', choices=[('1', _('Yes')), ('0', _('No'))])
    ...
    config.plugins.MyMetrix.Color.ProgressBar = ConfigMetrixBarColors('#00a61d4d')
