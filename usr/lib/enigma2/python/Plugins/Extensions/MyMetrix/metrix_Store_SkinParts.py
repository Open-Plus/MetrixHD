# Embedded file name: /usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/metrix_Store_SkinParts.py
import threading
...
class OpenScreen(Screen, ConfigListScreen):
    ...
    if screenWidth and screenWidth == 1920:
     skin = '\n<screen name="MyMetrix-Store-Browse" position="0,0" size="1920,1080" flags="wfNoBorder" backgroundColor="transparent">\n <widget position="947,773" size="533,32" name="isInstalled" foregroundColor="#00ffffff" font="Regular; 20" valign="center" halign="left" transparent="1" backgroundColor="#40000000" />\n<eLabel position="0,0" size="1920,1080" backgroundColor="transparent" zPosition="-50" />\n<eLabel position="315,center" size="620,700" backgroundColor="#40111111" zPosition="-1" />\n<eLabel position="935,center" size="614,636" backgroundColor="#40222222" zPosition="-1" />\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="985,818" size="165,33" text="%s" transparent="1" />\n <widget name="menu" position="325,262" scrollbarMode="showNever" size="601,591" transparent="1" foregroundColor="#00ffffff" backgroundColor="#40000000" />\n <widget position="946,633" size="592,136" name="description" foregroundColor="#00ffffff" font="Regular; 17" valign="center" halign="left" transparent="1" backgroundColor="#40000000" />n\  <widget position="345,205" size="558,50" name="title" foregroundColor="#00ffffff" font="SetrixHD; 40" valign="center" transparent="1" backgroundColor="#40000000" />\n  \n  <eLabel position="971,818" size="5,40" backgroundColor="#0000ff00" />\n<ePixmap pixmap="/usr/lib/enigma2/python/Plugins/Extensions/MyMetrix/images/star.png" position="1504,821" size="32,34" zPosition="1" alphatest="blend" />\n  <eLabel font="Regular; 20" foregroundColor="#00ffffff" backgroundColor="#40000000" halign="left" position="1209,818" size="149,33" text="%s" transparent="1" />\n<widget name="helperimage" position="946,338" size="592,291" zPosition="1" alphatest="blend" />\n<widget position="944,227" size="546,50" name="itemname" foregroundColor="#00ffffff" font="SetrixHD; 35" valign="center" transparent="1" backgroundColor="#40000000" />\n <widget position="1380,818" size="118,34" name="votes" foregroundColor="#00ffffff" font="Regular; 30" valign="center" halign="right" transparent="1" backgroundColor="#40000000" />\n<eLabel position="1200,818" zPosition="1" size="5,40" backgroundColor="#00ffff00" />\n<widget position="945,282" size="341,50" name="author" foregroundColor="#00bbbbbb" font="Regular; 28" valign="center" backgroundColor="#40000000" transparent="1" halign="left" />\n<widget position="1294,290" size="200,40" name="date" foregroundColor="#00999999" font="Regular; 25" valign="center" backgroundColor="#40000000" transparent="1" halign="right" zPosition="1" />\n\n\n </screen>\n' % (_('Install '), _('Vote'))
    else:
